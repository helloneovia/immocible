...
const api = {
    ...
    validation: {
        budgetRange: 'Budget invalide : le minimum doit être inférieur ou égal au maximum.',
        surfaceRange: 'Surface invalide : le minimum doit être inférieure ou égale au maximum.',
        invalidNumber: 'Le prix et la surface doivent être des nombres positifs.',
        postalCode: 'Code postal invalide (5 chiffres).',
        messageTooLong: 'Message trop long ({max} caractères maximum).',
        invalidEmail: 'Adresse e-mail invalide. Vérifiez sa saisie (ex. nom@exemple.fr).',
        passwordTooShort: 'Le mot de passe doit contenir au moins 8 caractères',
        passwordTooLong: 'Le mot de passe ne doit pas dépasser 128 caractères',
        invalidPhone: 'Numéro de téléphone invalide (8 à 15 chiffres).',
        agencyNameRequired: "Le nom de l'agence est requis",
        invalidPlan: 'Formule invalide',
        emailNotVerified: "Votre adresse e-mail n'a pas été vérifiée, ou la vérification a expiré. Recommencez l'inscription pour recevoir un nouveau code.",
