-- ============================================
-- SOLUTION FINALE CORRIGÉE - Fonction appelable par l'utilisateur
-- ============================================
...
-- 5. Créer la fonction trigger (séparément pour éviter les problèmes de délimiteurs)
...
-- 6. Essayer de créer le trigger (peut échouer si on n'a pas les permissions, ce n'est pas grave)
-- On utilise un bloc DO pour gérer l'erreur gracieusement
DO $trigger_block$
BEGIN
