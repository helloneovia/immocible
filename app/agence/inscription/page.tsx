...
import { Home, ArrowRight, Building2, CheckCircle2, Shield } from 'lucide-react'
          ...
          <Card className="shadow-2xl border-0 bg-white/80 backdrop-blur-xl">
            ...
            <CardContent>
              <form className="space-y-5">
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all duration-300 group"
                  size="lg"
                >
                  Créer mon compte agence
                ...
                <div className="text-center text-sm text-muted-foreground">
                  ...
                  <Link href="/agence/dashboard" className="text-indigo-600 hover:text-indigo-700 underline font-semibold">
                    Se connecter
                  </Link>
                </div>
