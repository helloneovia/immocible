        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl border shadow-sm p-6 space-y-6">
                <div className="flex items-center gap-2 border-b pb-4">
                    <div className="h-8 w-8 bg-blue-100 rounded-full flex items-center justify-center text-amber-500">
            ...
            <div className="flex justify-between pt-4 sticky bottom-4 z-10">
                {/* Bouton Supprimer */}
                <Button
                    onClick={handleDelete}
                    disabled={deleteLoading || loading}
                    className="bg-red-600 hover:bg-red-700 text-white shadow-lg px-8"
                >
                    {deleteLoading ? (
                        <>
                ...
                {/* Bouton Enregistrer */}
                <Button onClick={handleSave} disabled={loading || deleteLoading} className="bg-slate-900 hover:bg-indigo-700 text-white shadow-lg px-8">
                    {loading ? (
                        <>
                            <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
